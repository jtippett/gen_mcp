  ...
  def json_schema do
    %{
      ...
      definitions: %{
        ...
        "ResultMetaObject" => GenMCP.MCP.V2607.ResultMetaObject,
...
defmodule GenMCP.MCP.V2607.CacheableResult do
  ...
  defschema %{
    ...
    """,
    properties: %{
      _meta: GenMCP.MCP.V2607.ResultMetaObject,
...
defmodule GenMCP.MCP.V2607.DiscoverResult do
  ...
  JsonDerive.auto(
    _merge = %{},
    _keep_nils = [:cacheScope, :capabilities, :resultType, :supportedVersions, :ttlMs]
  )
...
defmodule GenMCP.MCP.V2607.ResultMetaObject do
  ...
  defschema %{
    ...
    """,
    properties: %{
      "io.modelcontextprotocol/serverInfo": GenMCP.MCP.V2607.Implementation
    },
    title: "MCP:ResultMetaObject",
    type: "object"
  }
